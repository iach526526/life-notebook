...
![export book on Google book](./1-export-book.png)
...
![Grant device on Adobe edition(Use Adobe Account)](./2-grant-device.png)

![Grant device on Adobe edition(no Adobe Account)](./3-grant-no-Account.png)
...
![insstall calibre](./4-calibre.png)
...
![preference](./6-preference.png)

![plugin import](./7-plugin.png)


## 匯入書本
![匯入書本，選擇檔案](./8-import-book.png)
